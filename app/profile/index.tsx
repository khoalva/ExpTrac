      ...
      >
        ...
        <View style={styles.settingsSection}>
          ...
          <TouchableOpacity style={styles.settingItem}>
            ...
            <View style={styles.settingContent}>
              <Text style={styles.settingTitle}>Saved Beneficiary</Text>
              <Text style={styles.settingDescription}>Manage your saved account</Text>
            </View>
            <ChevronRight size={20} color={colors.textSecondary} />
          </TouchableOpacity>
          ...
          <View style={styles.settingItem}>
            ...
            <View style={styles.settingContent}>
              ...
              <Text style={styles.settingDescription}>Switch to a darker theme</Text>
            </View>
            <Switch
              value={isDarkMode}
          ...
          <TouchableOpacity style={styles.settingItem}>
            ...
            <View style={styles.settingContent}>
              ...
              <Text style={styles.settingDescription}>Manage permission to read notifications</Text>
            </View>
            <ChevronRight size={20} color={colors.textSecondary} />
          </TouchableOpacity>
        ...
        <View style={styles.settingsSection}>
          ...
          <TouchableOpacity style={styles.settingItem}>
            ...
            <View style={styles.settingContent}>
              ...
              <Text style={styles.settingDescription}>Learn more about ExpTrac</Text>
            </View>
            <ChevronRight size={20} color={colors.textSecondary} />
          </TouchableOpacity>
        </View>
