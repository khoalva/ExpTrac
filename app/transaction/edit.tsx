                            ...
                            <Controller
                                ...
                                render={({ field: { onChange, value } }) => (
                                    <Select
                                        ...
                                        <SelectTrigger
                                            variant="outline"
                                            className="w-full h-fit rounded-xl bg-white flex justify-start items-center "
                                            size="md">
                                            <SelectInput
                        ...
                        <Controller
                            ...
                            render={({ field: { onChange, value } }) => (
                                <Select
                                    ...
                                    <SelectTrigger
                                        variant="outline"
                                        className="w-full h-fit rounded-xl bg-white flex justify-between items-center p-3"
                                        size="md">
                                        <SelectInput
